...
type Step3 = { pricePaid: string; discountAmount: string };
type Step4 = { username: string; password: string; confirmPassword: string };
...
export default function DurationRegisterPage() {
  ...
  const [s3, setS3] = React.useState<Step3>({ pricePaid: '', discountAmount: '' });
  ...
  return (
    <Box sx={{ maxWidth: 960, mx: 'auto', p: { xs: 2, md: 3 } }}>
      <Typography variant="h5" sx={{ mb: 2, fontWeight: 700 }}>Register Duration Product</Typography>
      <Paper sx={{ p: { xs: 2, md: 3 } }} elevation={2}>
        <Stepper activeStep={activeStep} sx={{ mb: 3 }}>
          {['Customer Info', 'Additional Info', 'Duration Details', 'Account Credentials'].map((l) => (
